...
Archivo exportado: `API Autos.postman_collection.json`

## Evidencias

_(Insertar las capturas de pantalla solicitadas)_

- [ ] GET de todos los autos
- [ ] GET por ID
- [ ] POST con ID manual
- [ ] POST con ID automático
- [ ] PUT
- [ ] DELETE
- [ ] Al menos una respuesta de error
